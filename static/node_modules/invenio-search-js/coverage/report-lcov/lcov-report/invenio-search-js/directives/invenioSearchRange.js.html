...
<html lang="en">
<head>
    <title>Code coverage report for invenio-search-js/directives/invenioSearchRange.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">invenio-search-js/directives/</a> invenioSearchRange.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (responsive) {
...
&nbsp;
    ...
    function changeUserSelection(from, to) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!isNaN(from) &amp;&amp; !isNaN(to)) {
        // Update Args
        var params = {};
        var rangeParams = {
          from: from,
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    function resetUserSelection() {</span>
<span class="cstat-no" title="statement not covered" >        var params = {};</span>
<span class="cstat-no" title="statement not covered" >        delete options.selectionRange;</span>
<span class="cstat-no" title="statement not covered" >        params[options.name] = [];</span>
        // Request a new search
<span class="cstat-no" title="statement not covered" >        scope.$broadcast('invenio.search.params.change', params);</span>
    }
&nbsp;
    /**
     * Determine if the user selected a range
     */
<span class="fstat-no" title="function not covered" >    function isRangeSelected() {</span>
<span class="cstat-no" title="statement not covered" >        return options.selectionRange === undefined ? false : true;</span>
    }
&nbsp;
    /**
    ...
    function updateRange() {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (responsive) {
        options.width = getRangeWidth() || <span class="branch-1 cbranch-no" title="branch not covered" >initialWidth;</span>
      }
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (vm.invenioSearchResults.aggregations) {
        var buckets = vm.invenioSearchResults.aggregations[options.name].buckets;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (buckets.length &gt; 0) {
          if (vm.invenioSearchArgs[options.name] &amp;&amp; vm.invenioSearchArgs[options.name].length &gt; 0) {
            ...
            var rMin = +args[0];
            var rMax = (args.length === 2) ? +args[1] : <span class="branch-1 cbranch-no" title="branch not covered" >rMin;</span>
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!isNaN(rMin) &amp;&amp; !isNaN(rMax)) {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Jan 08 2018 15:21:38 GMT+0100 (CET)
</div>
</div>
